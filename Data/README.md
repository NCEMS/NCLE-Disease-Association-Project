...
## Downloading Data from CyVerse

The required data for this project is hosted on CyVerse due to its large
size and is not included directly in this repository.

1.  Create a free CyVerse account:  
    <https://user.cyverse.org/signup>

2.  Access the data using the following link:  
...
3.  Download the folder named **Data_Cyverse**.

4.  Move all files and subfolders inside **Data_Cyverse** into this
    `Data/` directory.

The final structure of the `Data/` folder in this repository should
match the contents of the Data_Cyverse folder exactly before running any
analyses.
...
|----|----|
| uniprotids | UniProt identifier for the protein |
| Association_ID | Unique identifier for the gene–disease association |
| EntreID | NCBI Entrez Gene identifier |
| Entanglement | Binary indicator (“Yes”/“No”) of whether the protein contains at least one non-covalent lasso entanglement (NCLE) |
| Cov_Entanglement | Binary indicator (“Yes”/“No”) of whether the protein contains at least one covalent lasso entanglement (CLE) |
| Knot | Binary indicator (“Yes”/“No”) of whether the protein contains a topological knot |
| 50th_percentile | Binary indicator (“Yes”/“No”) of whether the protein has at least one disease association with a DisGeNET score in the 50th percentile or higher |
| 75th_percentile | Binary indicator (“Yes”/“No”) of whether the protein has at least one disease association with a DisGeNET score in the 75th percentile or higher |
| 95th_percentile | Binary indicator (“Yes”/“No”) of whether the protein has at least one disease association with a DisGeNET score in the 95th percentile or higher |
...
| disease | Binary indicator (“Yes”/“No”) of whether the protein is classified as disease-associated based on DisGeNET score thresholds |
...
- `final_dfA02_22_2026.csv` (uniprotids, Entanglement, Cov_Entanglement,
  Knot)
...
### UniScoDis*plddt_0*.csv

**Used in:** `Functions/dataProcessingClass.R`

Precomputed protein-level datasets corresponding to DisGeNET percentile
thresholds (50th, 75th, and 95th). Separate files are provided for
AlphaFold (af) and crystal (crystal) datasets. These files are used to
quickly load disease association summaries without recomputing
percentile thresholds.

Each file represents one percentile threshold and dataset type:

- UniScoDis50\_\* — 50th percentile
- UniScoDis75\_\* — 75th percentile
- UniScoDis95\_\* — 95th percentile

| Column Name | Definition |
|----|----|
| uniprotids | UniProt identifier for the protein |
| Entanglement | Binary indicator (“Yes”/“No”) of whether the protein contains at least one non-covalent lasso entanglement |
| Length | Total protein length (number of residues) |
| Essential | Gene essentiality classification: “Yes”, “No”, or “NT” |
| plddt | Mean pLDDT score across the protein (AlphaFold structural confidence metric) |
| \[Disease classes\] | Binary indicators (“Yes”/“No”) for disease association across 23 MeSH disease classes |

These datasets are filtered to pLDDT ≥ 70 during processing and are
primarily used for class-level disease association analyses across
percentile thresholds.
